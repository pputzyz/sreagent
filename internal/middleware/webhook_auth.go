...
// secret.  The client must pass the header X-Webhook-Secret.
// If secret is empty, the middleware rejects ALL requests — this is intentional
// so that deployments must explicitly configure a secret before the webhook
