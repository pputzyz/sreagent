...
func seedPresetRules(db *gorm.DB, logger *zap.Logger) {
	...
	presets := []preset{
		...
		// ── Inhibition Presets ──
		{
			Name: "inhibit-host-severity-cascade", DisplayName: "主机严重等级级联抑制", Category: "inhibition", SubCategory: "severity", Component: "engine",
			Expression: `{"source_match":{"severity":"P0"},"target_match":{"severity":"~P1|P2|P3"},"equal_labels":["instance","project"]}`, Severity: "info", AlertType: "inhibition",
			Labels: model.JSONLabels{"source_match": "severity=P0", "target_match": "severity=~P1|P2|P3", "equal_labels": "instance,project"},
			Description: "P0 告警触发时，抑制同实例的 P1/P2/P3 告警",
		},
		{
			Name: "inhibit-node-down-cascade", DisplayName: "节点宕机级联抑制", Category: "inhibition", SubCategory: "availability", Component: "engine",
			Expression: `{"source_match":{"alertname":"NodeExporterDown"},"target_match":{"severity":"~P0|P1|P2|P3"},"equal_labels":["instance","project"]}`, Severity: "info", AlertType: "inhibition",
			Labels: model.JSONLabels{"source_match": "alertname=NodeExporterDown", "target_match": "severity=~P0|P1|P2|P3", "equal_labels": "instance,project"},
			Description: "NodeExporterDown 时抑制该主机的所有严重等级告警",
		},
		{
			Name: "inhibit-kube-node-notready", DisplayName: "K8s 节点 NotReady 级联抑制", Category: "inhibition", SubCategory: "kubernetes", Component: "engine",
			Expression: `{"source_match":{"alertname":"KubeNodeNotReady"},"target_match":{"category":"container"},"equal_labels":["node","project"]}`, Severity: "info", AlertType: "inhibition",
			Labels: model.JSONLabels{"source_match": "alertname=KubeNodeNotReady", "target_match": "category=container", "equal_labels": "node,project"},
			Description: "K8s 节点 NotReady 时抑制该节点上的容器告警",
		},
		{
			Name: "inhibit-probe-failed-cascade", DisplayName: "探测失败级联抑制", Category: "inhibition", SubCategory: "probe", Component: "engine",
			Expression: `{"source_match":{"alertname":"BlackboxHttpProbeFailed"},"target_match":{"alertname":"~BlackboxHttpProbeLatency.*|BlackboxHttpStatus5xx"},"equal_labels":["instance","project"]}`, Severity: "info", AlertType: "inhibition",
			Labels: model.JSONLabels{"source_match": "alertname=BlackboxHttpProbeFailed", "target_match": "alertname=~BlackboxHttpProbeLatency.*|BlackboxHttpStatus5xx", "equal_labels": "instance,project"},
